...
public class ElevatorIOHardware implements ElevatorIO
{
    ...
    public ElevatorIOHardware()
    {
        ...
        leaderConfig.idleMode(IdleMode.kBrake).voltageCompensation(Constants.General.MOTOR_VOLTAGE).inverted(false).smartCurrentLimit(80);
        ...
        followerConfig.idleMode(IdleMode.kBrake).voltageCompensation(Constants.General.MOTOR_VOLTAGE).follow(Constants.CAN.LEAD_ELEVATOR, false).smartCurrentLimit(80);
